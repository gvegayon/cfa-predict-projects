...
dat <- data.frame(
  ...
  `Activity (issues/branches)` = sprintf(
    ...
    sprintf(
      '<img src="https://img.shields.io/github/last-commit/%s.svg">',
      repos$repository
    ),
    # Issues
    sprintf("https://github.com/%s/issues", repos$repository),
    sprintf(
      "<img src='https://img.shields.io/github/issues/%s.svg'>",
      repos$repository
      ),
    # Pull requests
    sprintf("https://github.com/%s/branches", repos$repository),
    sprintf(
      "<img src='https://img.shields.io/github/issues-pr/%s.svg'>",
      repos$repository
    ),
    # Branches
    sprintf("https://github.com/%s/branches", repos$repository),
    sprintf(
      "<img src='https://img.shields.io/badge/branches-%i-violet'>",
